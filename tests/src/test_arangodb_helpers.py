...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(dict(cve_id='CVE-2024-1234,CVE-2024-123456'), ["indicator--815e3b87-d1e1-52fb-aa44-0dc7a9b55116"], id='cve_id good+bad'),
        pytest.param(dict(cve_id='CVE-2024-3094,CVE-2024-1234'), ["indicator--815e3b87-d1e1-52fb-aa44-0dc7a9b55116", "indicator--881e6846-697c-5ec9-a353-32c448827930"], id='cve_id good+good'),
        pytest.param(dict(cve_id='CVE-2024-3094,CVE-2024-1234', attack_id="T1059"), ["indicator--815e3b87-d1e1-52fb-aa44-0dc7a9b55116"], id='cve_id + attack_id'),
        pytest.param(dict(file_id='some-id'), [], id='bad file id'),
        pytest.param(dict(file_id='60915f4c-fa2d-5bf1-b7d1-d7ecab167560'), ["indicator--881e6846-697c-5ec9-a353-32c448827930"], id='good file id'),
        pytest.param(dict(report_id='some-id'), [], id='bad report id'),
        pytest.param(dict(report_id='report--60915f4c-fa2d-5bf1-b7d1-d7ecab167560'), ["indicator--881e6846-697c-5ec9-a353-32c448827930"], id='good report id'),
        pytest.param(dict(name='this will not be found'), [], id='bad name'),
        pytest.param(dict(name='tarballs'), ["indicator--881e6846-697c-5ec9-a353-32c448827930"], id='good name'),
        pytest.param(dict(name='taRbALls'), ["indicator--881e6846-697c-5ec9-a353-32c448827930"], id='good name bad case'),
        pytest.param(dict(name='eLemENtor'), ["indicator--815e3b87-d1e1-52fb-aa44-0dc7a9b55116"], id='good name bad case 2'),
