...
class FileSerializer(serializers.ModelSerializer):
    ...
    tlp_level = serializers.ChoiceField(choices=TLP_Levels.choices, default=TLP_Levels.CLEAR.value, help_text='This will be assigned to all SDOs and SROs created. Stixify uses TLPv2. Either `clear`, `green`, `amber`, `amber+strict`, `red`. This is a txt2detection setting.')
...
class RuleCloneSerializer(serializers.Serializer):
    ...
    tlp_level = serializers.ChoiceField(choices=TLP_Levels.choices, default=None, help_text='This will be assigned to all SDOs and SROs created. Stixify uses TLPv2. Either `clear`, `green`, `amber`, `amber+strict`, `red`. This is a txt2detection setting.')
